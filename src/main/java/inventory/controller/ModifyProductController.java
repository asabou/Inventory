...
public class ModifyProductController implements Initializable, Controller {
    ...
    private static final Logger logger = Logger.getLogger(ModifyProductController.class.getName());
    ...
    public ModifyProductController(){
        //empty constructor pentru fisierele fxml
    }
